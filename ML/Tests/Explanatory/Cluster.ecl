// K-MEANS AND YINYANG K-MEANS
//
// Presents K-Means and Yinyang K-Means clustering in a 2-dimensional space. 100 data points
...
YinyangKMeans:=ML.Cluster.YinyangKMeans(dDocuments,dCentroids,dCentroids(id = 2),30,.3); 		// Set up YinYangKMeans with a maximum of 30 iterations and .3 as a convergence threshold
...
YinyangKMeans.Result(12);                                       // The results of iteration 12
YinyangKMeans.Delta(5,15);                                      // The distance every centroid travelled across each axis from iterations 5 to 15
YinyangKMeans.Delta(0);                                         // The total distance the centroids travelled on each axis
