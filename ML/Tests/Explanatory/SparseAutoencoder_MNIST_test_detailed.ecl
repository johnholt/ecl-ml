...
//FF2 returns a2
 ...
 //FF3 returns a3
    ...
    END;
        ...
        a2 := FF2 (w1dist, b1vecdist);
        // a3 := FF3 (w2dist, b2vecdist, a2);
        // a3_m := DMat.Converted.FromPart2Elm(a3);
        // output(a3_m(x=1));
        ...
        a33 := PBblas_v0.Apply2Elements(b2map, z3, sigmoid);
        ma := ML.dMat.Converted.FromPart2Elm(z3);
        output(ma(x=1));
        // d3 := DELTA3 (a3);
        // d2 := DELTA2 (w2dist, a2, d3);
        // wg1 := WeightGrad1 (w1dist, d2);
        // wg2 := WeightGrad2 (w2dist, d3, a2);
        // bg1 := BiasGrad1 (d2);
        // bg2 := BiasGrad2 (d3);
        // w1u := GradDesUpdate (w1dist, wg1);
        // w2u := GradDesUpdate (w2dist, wg2);
        // b1u := GradDesUpdate (b1vecdist, bg1);
        // b2u := GradDesUpdate (b2vecdist, bg2);
        // z3mat := DMat.Converted.FromPart2Elm (z3);
        // mm := max (z3mat, x);
         // output(max(z3mat,x));
