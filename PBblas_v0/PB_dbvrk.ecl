...
EXPORT PB_dbvrk(BOOLEAN transposeA, value_t alpha, PBblas_v0.IMatrix_Map a_map,
                DATASET(Layout_Part) A, PBblas_v0.IMatrix_Map c_map,
  ...
  a_ok := ASSERT(A, ASSERT(compat, PBblas_v0.Constants.Dimension_Incompat, FAIL));
