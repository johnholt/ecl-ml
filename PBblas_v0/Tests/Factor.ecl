...
map_8x8_1  := PBblas_v0.Matrix_Map(8, 8, 8, 8);
map_8x8_9  := PBblas_v0.Matrix_Map(8, 8, 3, 3);
b1 := DMAT.Converted.FromCells(map_8x8_1, b_cells);
// Make a symteric positive definite matrix for Cholesky
a1 := PBblas_v0.PB_dgemm(TRUE, FALSE, 1.0, map_8x8_1, b1, map_8x8_1, b1, map_8x8_1);
...
C_U1 := PBblas_v0.PB_dpotrf(Upper, map_8x8_1, a1);
C_U9 := PBblas_v0.PB_dpotrf(Upper, map_8x8_9, a9);
C_L1 := PBblas_v0.PB_dpotrf(Lower, map_8x8_1, a1);
C_L9 := PBblas_v0.PB_dpotrf(Lower, map_8x8_9, a9);

// Single partition Choleky
C_U1tU1 := PBblas_v0.PB_dgemm(TRUE, FALSE,
                           1.0, map_8x8_1, C_U1, map_8x8_1, C_U1,
                           map_8x8_1);
test_c1 := Tests.DiffReport.Compare_Parts('Cholesky U1tU1', a1, C_U1tU1);

C_L1U1  := PBblas_v0.PB_dgemm(FALSE, FALSE,
                           1.0, map_8x8_1, C_L1, map_8x8_1, C_U1,
                           map_8x8_1);
test_c2 := Tests.DiffReport.Compare_Parts('Cholesky L1U1', a1, C_L1U1);

C_L1L1t := PBblas_v0.PB_dgemm(FALSE, TRUE,
...
// Single partition LU
T_1  := PBblas_v0.PB_dgetrf(map_8x8_1, b1);
T_U1 := PBblas_v0.PB_Extract_Tri(Upper, NotUnitTri, map_8x8_1, T_1);
T_L1 := PBblas_v0.PB_Extract_Tri(Lower, UnitTri, map_8x8_1, T_1);
T_L1U1 := PBblas_v0.PB_dgemm(FALSE, FALSE,
                          1.0, map_8x8_1, T_L1, map_8x8_1, T_U1,
                          map_8x8_1);
test_t1 := Tests.DiffReport.Compare_Parts('LU L1U1', b1, T_L1U1);

// Multiple partition LU
T_9  := PBblas_v0.PB_dgetrf(map_8x8_9, b9);
T_U9 := PBblas_v0.PB_Extract_Tri(Upper, NotUnitTri, map_8x8_9, T_9);
T_L9 := PBblas_v0.PB_Extract_Tri(Lower, UnitTri, map_8x8_9, T_9);
T_L9U9 := PBblas_v0.PB_dgemm(FALSE, FALSE,
