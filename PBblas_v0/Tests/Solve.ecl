...
// Run 1 partition
C_L1 := PBblas_v0.PB_dpotrf(Lower, map_1, a1);
C_S1 := PBblas_v0.PB_dtrsm(Side.Ax, Lower, FALSE, Diagonal.NotUnitTri,
                      1.0, map_1, C_L1, map_1, E1);
C_T1 := PBblas_v0.PB_dtrsm(Side.Ax, Upper, TRUE, Diagonal.NotUnitTri,
                      1.0, map_1, C_L1, map_1, C_S1);
test_1 := PBblas_v0.Tests.DiffReport.Compare_Parts('Ax Solve, Single, Cholesky', x1, C_T1);

E_LU1:= PBblas_v0.PB_dgetrf(map_1, a1);
E_S1 := PBblas_v0.PB_dtrsm(Side.Ax, Lower, FALSE, Diagonal.UnitTri,
                      1.0, map_1, E_LU1, map_1, E1);
E_T1 := PBblas_v0.PB_dtrsm(Side.Ax, Upper, FALSE, Diagonal.NotUnitTri,
                      1.0, map_1, E_LU1, map_1, E_S1);
test_2 := PBblas_v0.Tests.DiffReport.Compare_Parts('Ax Solve, Single, LU', x1, E_T1);

F_LU1:= E_LU1;
F_S1 := PBblas_v0.PB_dtrsm(Side.xA, Upper, FALSE, Diagonal.NotUnitTri,
                      1.0, map_1, F_LU1, map_1, F1);
F_T1 := PBblas_v0.PB_dtrsm(Side.xA, Lower, FALSE, Diagonal.UnitTri,
                      1.0, map_1, F_LU1, map_1, F_S1);
test_3:=PBblas_v0.Tests.DiffReport.Compare_Parts('xA Solve, Single, LU', x1, F_T1);
...
C_U2  := PBblas_v0.PB_dpotrf(Upper, map_2, a2);
C_S2  := PBblas_v0.PB_dtrsm(Side.Ax, Lower, TRUE, Diagonal.NotUnitTri,
                      1.0, map_2, C_U2, map_2, E2);
C_T2  := PBblas_v0.PB_dtrsm(Side.Ax, Upper, FALSE, Diagonal.NotUnitTri,
                      1.0, map_2, C_U2, map_2, C_S2);
test_4:= PBblas_v0.Tests.DiffReport.Compare_Parts('Ax Solve, Multiple, Cholesky', x1, C_T2);

E_LU2 := PBblas_v0.PB_dgetrf(map_2, a2);
E_S2  := PBblas_v0.PB_dtrsm(Side.Ax, Lower, FALSE, Diagonal.UnitTri,
                      1.0, map_2, E_LU2, map_2, E2);
E_T2  := PBblas_v0.PB_dtrsm(Side.Ax, Upper, FALSE, Diagonal.NotUnitTri,
                      1.0, map_2, E_LU2, map_2, E_S2);
test_5:= PBblas_v0.Tests.DiffReport.Compare_Parts('Ax Solve, Multiple, LU', x1, E_T2);

F_LU2 := E_LU2;
F_S2  := PBblas_v0.PB_dtrsm(Side.xA, Upper, FALSE, Diagonal.NotUnitTri,
                      1.0, map_2, F_LU2, map_2, F2);
F_T2  := PBblas_v0.PB_dtrsm(Side.xA, Lower, FALSE, Diagonal.UnitTri,
                      1.0, map_2, F_LU2, map_2, F_S2);
test_6:= PBblas_v0.Tests.DiffReport.Compare_Parts('xA Solve, Multiple, LU', x1, F_T2);
